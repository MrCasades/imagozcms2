...
include_once $_SERVER['DOCUMENT_ROOT'] . '/header.inc.php';?>
	...
	<div class = "maincont_for_view"> 
		...
		<hr/>
		<p align = "center"> <a href="<?php echo '//'.$_SERVER['SERVER_NAME'].'/admin/commentnewslist/';?>" class="btn btn-info">Комментарии новостей</a> | 
		<a href="<?php echo '//'.$_SERVER['SERVER_NAME'].'/admin/commentpostlist/';?>" class="btn btn-primary btn-sm">Комментарии статей</a> |
		<a href="<?php echo '//'.$_SERVER['SERVER_NAME'].'/admin/commentpromotionlist/';?>" class="btn btn-primary btn-sm">Комментарии промоушен статей</a></p>
		
		<div>
		<?php if (!isset($newsComments))
				{
