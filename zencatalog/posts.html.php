		...
		<div class="columns__panel">
         <div class="columns__panel-content">
			<div class = "post_for_columns" style = "background: url(/images/<?php echo $news['imghead']; ?>); background-size: cover; ">
				<div  class = "posttitle"><strong><?php echo date("Y.m.d H:m", strtotime($news['newsdate'])); ?> </strong></div>
	...
	<div class="for_allposts_link"><p align = "center"><a href="/viewallnews/" style = "color: white">Все новости</a></p></div>
	 ...
	 <?php if (!isset($newsInTOP))
	  ...
	  <div class="columns__panel">
       <div class="columns__panel-content">	   
		<div class = "fortop5">  
          <img width = "8%" height = "8%" src="<?php echo '//'.$_SERVER['SERVER_NAME'];?>/view.jpg" alt="Число просмотров материала" title="Просмотры"> <?php htmlecho ($newsTOP['viewcount']); ?> 
		  <img width = "5%" height = "5%" src="<?php echo '//'.$_SERVER['SERVER_NAME'];?>/like.jpg" alt="Оценка материала" title="Оценка"> <?php htmlecho ($newsTOP['averagenumber']); ?>			
...
<script type="text/javascript">
	...
	<div class="columns">
		<?php if (!isset($newsIn))
		 {
			 $noPosts = '<p align = "center">Рекомендации отсутствуют</p>';
			 echo $noPosts;
			 $newsIn = null;
		 }
		...
		<div class="columns__panel">
         <div class="columns__panel-content">
			<div class = "post_for_columns" style = "background: url(/images/<?php echo $lastRecommPost['imghead']; ?>); background-size: cover; ">
				<div  class = "posttitle"><strong><?php echo date("Y.m.d H:m", strtotime($lastRecommPost['postdate'])); ?> </strong></div>
...
<script>
	 ...
	 <?php if (!isset($promotionsTOP))
	  ...
	  <div class="columns__panel">
       <div class="columns__panel-content">	   
		<div class = "fortop5">  
          <img width = "8%" height = "8%" src="<?php echo '//'.$_SERVER['SERVER_NAME'];?>/view.jpg" alt="Число просмотров материала" title="Просмотры"> <?php htmlecho ($promotionTOP['viewcount']); ?> 
		  <img width = "5%" height = "5%" src="<?php echo '//'.$_SERVER['SERVER_NAME'];?>/like.jpg" alt="Оценка материала" title="Оценка"> <?php htmlecho ($promotionTOP['averagenumber']); ?>			
	 ...
	 <?php if (!isset($postsTOP))
	  ...
	  <div class="columns__panel">
       <div class="columns__panel-content">	   
		<div class = "fortop5">  
          <img width = "8%" height = "8%" src="<?php echo '//'.$_SERVER['SERVER_NAME'];?>/view.jpg" alt="Число просмотров материала" title="Просмотры"> <?php htmlecho ($postTOP['viewcount']); ?> 
		  <img width = "5%" height = "5%" src="<?php echo '//'.$_SERVER['SERVER_NAME'];?>/like.jpg" alt="Оценка материала" title="Оценка"> <?php htmlecho ($postTOP['averagenumber']); ?>			
	...
	<table align = "center">
	 ...
	 <tr>
		<td>
			 <a href="https://zen.yandex.ru/imagoz" rel = "nofollow"><img width = "75%" height = "75%" src="<?php echo '//'.$_SERVER['SERVER_NAME'];?>/zen-icon.png" alt="Наш Дзен-канал" title="zen.yandex.ru/imagoz"></a></td><td><script type="text/javascript" src="https://vk.com/js/api/openapi.js?160"></script>
