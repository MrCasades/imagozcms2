...
include_once $_SERVER['DOCUMENT_ROOT'] . '/header.inc.php';?>
	...
	<p> <a href="<?php echo '//'.$_SERVER['SERVER_NAME'].'/searchpost/';?>" class="btn btn-primary btn-sm">Поиск статей</a> | 
		<a href="<?php echo '//'.$_SERVER['SERVER_NAME'].'/searchpromotion/';?>" class="btn btn-info">Поиск промоушен-статей</a> |
		<a href="<?php echo '//'.$_SERVER['SERVER_NAME'].'/searchnews/';?>" class="btn btn-primary btn-sm">Поиск новостей</a></p>
