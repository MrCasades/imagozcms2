		 ...
		 foreach ($newsIn as $news): ?> 
			...
			<div>
				...
				<div class = "post">
				  ...
				  <div class = "newstext">
					<h5 align = "center"><?php htmlecho ($news['newstitle']); ?></h5>
		...
		<div align = "center">	
		 <?php
			...
			for ($i = 1; $i <= $pagesCount; $i++) 
			{
				...
				if($i == $page)
				{
					echo "<a href='index.php?page=$i&id=$idCategory' class='btn btn-info'>$i</a> ";
				} 
				else 
				{
					echo "<a href='index.php?page=$i&id=$idCategory' class='btn btn-primary btn-sm'>$i</a> ";
				}
			}?>
		</div>	
		</div>
