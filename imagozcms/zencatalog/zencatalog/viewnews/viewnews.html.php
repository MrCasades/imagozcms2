		 ...
		 <?php foreach ($newsIn as $news): ?> 	  
			<div  align="justify">
				...
				<div class = "posttitle">
				  ...
				  <hr>
				   <p class="like"> 
				    <img width = "5%" height = "5%" src="<?php echo '//'.$_SERVER['SERVER_NAME'];?>/view.jpg" alt="Число просмотров материала" title="Просмотры"> <?php htmlecho ($news['viewcount']); ?> 
				    <img width = "3%" height = "3%" src="<?php echo '//'.$_SERVER['SERVER_NAME'];?>/like.jpg" alt="Оценка материала" title="Оценка"> <?php htmlecho ($news['averagenumber']); ?>
				   </p>
				<?php if ($news['imghead'] == '')
					{
					...
					<p><strong><a href="https://zen.yandex.ru/imagoz" rel = "nofollow">
						<img width = "5%" height = "5%" src="<?php echo '//'.$_SERVER['SERVER_NAME'];?>/zen-icon.png" alt="Наш Дзен-канал" title="zen.yandex.ru/imagoz">Подписывайтесь на наш Дзен-канал!</a></strong>
					</p>
			</div>	   	
		 <?php endforeach; ?>
		</div>
