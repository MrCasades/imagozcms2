...
if (isset ($_GET['id']))
{
	...
	{
		$authors[] =  array ('id' => $row['id'], 'authorname' => $row['authorname'], 'email' => $row['email'], 'www' => $row['www'], 'regdate' => $row['regdate'],
	...
	if ($selectedAuthor != $idAuthor)
	{
		$mainMessagesForm = '<form action = "/mainmessages/addupdmainmessage/" method = "post">
								<div>
...
if (isset ($_GET['changepass']))
{
	...
	elseif ($_POST['password'] != '')
	{
		...
		foreach ($s as $row)
		{
			$newPass[] = array('password' => $row['password']);
		}
