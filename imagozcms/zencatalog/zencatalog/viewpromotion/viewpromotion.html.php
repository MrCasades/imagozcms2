		 ...
		 <?php foreach ($promotions as $promotion): ?> 	  
			<div  align="justify">
			   ...
			   <hr>
				  ...
				  <hr>
				    <p class="like"> 
				     <img width = "5%" height = "5%" src="<?php echo '//'.$_SERVER['SERVER_NAME'];?>/view.jpg" alt="Число просмотров материала" title="Просмотры"> <?php htmlecho ($promotion['viewcount']); ?> 
				     <img width = "3%" height = "3%" src="<?php echo '//'.$_SERVER['SERVER_NAME'];?>/like.jpg" alt="Оценка материала" title="Оценка"> <?php htmlecho ($promotion['averagenumber']); ?>
					</p>
