...
--
-- Хост: 127.0.0.1
-- Время создания: Янв 24 2019 г., 21:31
...
--
ALTER TABLE `authorrole`
  ADD CONSTRAINT `authorrole_ibfk_1` FOREIGN KEY (`idauthor`) REFERENCES `author` (`id`),
  ADD CONSTRAINT `authorrole_ibfk_2` FOREIGN KEY (`idrole`) REFERENCES `role` (`id`);
...
ALTER TABLE `comments`
  ...
  ADD CONSTRAINT `comments_ibfk_3` FOREIGN KEY (`idauthor`) REFERENCES `author` (`id`),
  ADD CONSTRAINT `comments_ibfk_4` FOREIGN KEY (`idpost`) REFERENCES `posts` (`id`),
  ADD CONSTRAINT `comments_ibfk_5` FOREIGN KEY (`idnews`) REFERENCES `newsblock` (`id`);

--
-- Ограничения внешнего ключа таблицы `metapost`
--
ALTER TABLE `metapost`
  ADD CONSTRAINT `metapost_ibfk_1` FOREIGN KEY (`idmeta`) REFERENCES `meta` (`id`),
  ADD CONSTRAINT `metapost_ibfk_2` FOREIGN KEY (`idpost`) REFERENCES `posts` (`id`),
  ADD CONSTRAINT `metapost_ibfk_3` FOREIGN KEY (`idnews`) REFERENCES `newsblock` (`id`);

--
-- Ограничения внешнего ключа таблицы `newsblock`
--
ALTER TABLE `newsblock`
  ADD CONSTRAINT `newsblock_ibfk_1` FOREIGN KEY (`idauthor`) REFERENCES `author` (`id`),
  ADD CONSTRAINT `newsblock_ibfk_2` FOREIGN KEY (`idcategory`) REFERENCES `category` (`id`);

--
-- Ограничения внешнего ключа таблицы `posts`
--
ALTER TABLE `posts`
  ADD CONSTRAINT `posts_ibfk_1` FOREIGN KEY (`idauthor`) REFERENCES `author` (`id`),
  ADD CONSTRAINT `posts_ibfk_2` FOREIGN KEY (`idcategory`) REFERENCES `category` (`id`);

--
-- Ограничения внешнего ключа таблицы `votedauthor`
--
ALTER TABLE `votedauthor`
  ADD CONSTRAINT `votedauthor_ibfk_1` FOREIGN KEY (`idauthor`) REFERENCES `author` (`id`),
  ADD CONSTRAINT `votedauthor_ibfk_2` FOREIGN KEY (`idpost`) REFERENCES `posts` (`id`),
  ADD CONSTRAINT `votedauthor_ibfk_3` FOREIGN KEY (`idnews`) REFERENCES `newsblock` (`id`);
COMMIT;
