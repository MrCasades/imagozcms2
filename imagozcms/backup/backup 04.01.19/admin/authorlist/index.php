...
$title = 'Список авторов';//Данные тега <title>
...
if (isset ($_GET['editform']))
{
	...
	try
	{
		$sql = 'UPDATE author SET authorname = :authorname, email = :email, www = :www WHERE id = :id';// псевдопеременная получающая значение из формы
		$s = $pdo->prepare($sql);// подготавливает запрос для отправки в бд и возвр объект запроса присвоенный переменной
