...
include_once $_SERVER['DOCUMENT_ROOT'] . '/includes/header.inc.php';?>
	...
	<div class = "maincont">
		 ...
		 <?php foreach ($posts as $post): ?> 	  
			<div  align="justify">
				...
				<h3><?php echo ($post['posttitle']. 'Post #'.$post['id']); ?></h3>
					...
					<p>Количество просмотров: <?php htmlecho ($post['viewcount']); ?> Оценка: <?php htmlecho ($post['averagenumber']); ?></p>
		...
		<?php if (!isset($comments))
				...
				<div>
				 <fieldset><legend><h6><b>Прокомментировал <?php echo $comment['authorname']; ?></b> <?php echo $comment['date'];?></h6> </legend>		
				  <p><?php echomarkdown ($comment['text']); ?></p>
				   ...
				   $viewComments = '<a href="/imagozcms/viewcomments/?idpost='.$post['id'].'" class="btn btn-primary"> Отобразить все комментарии</a>';
				...
				<?php endforeach; ?> 
				<p align="center"><?php echo $viewComments; ?></p>	
		</div>		
	</div>		
