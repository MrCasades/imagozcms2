 ...
 /*Скрипт оценки статьи*/
	...
	if (isset($_GET['vote']))
	{
		...
		catch (PDOException $e)
		{
			...
			$error = 'Error transaction 1 '.$e -> getMessage();// вывод сообщения об ошибке в переменой $e;// вывод сообщения об ошибке в переменой $e;// вывод сообщения об ошибке в переменой $e
			include 'error.html.php';
			exit();		
		}
	...
	{
		$delAndUpd = "<form action = '/imagozcms/admin/addupdpost/' method = 'post'>
...
{		
	...
	$title = 'ImagozCMS | Редактирование комментария';//Данные тега <title>
